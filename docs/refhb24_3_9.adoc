...
Durch INTERLIS selbst ist die abstrakte Einheit `ANYUNIT` definiert. Alle anderen Einheiten erben sie direkt oder indirekt (vgl. <<_referenzsysteme>>), ohne dass dies definiert werden muss. Folgende Einheiten sind durch INTERLIS direkt (d.h. intern) definiert:
